...
element = wait.until(EC.element_to_be_clickable((By.XPATH, '/html/body/div[3]/div[4]/div[4]/div/div[2]/ul/li[2]')))
POW_TEC_BCD_button = driver.find_element(By.XPATH, "/html/body/div[3]/div[4]/div[4]/div/div[2]/ul/li[2]")
